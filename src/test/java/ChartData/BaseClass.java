...
public class BaseClass {
	...
	//locators by name-7
	public static WebElement elementByName(String datas) {
		WebElement element = driver.findElement(By.name(datas));
		return element;
	}
	//locators by class-8
	public static WebElement elementByClass(String datas) {
		WebElement element = driver.findElement(By.className(datas));
		return element;
	}
	//locators by xpath-9
	public static WebElement elementByXpath(String datas) {
	...
	//scroll down-29
	public static void javaexecutorScrollDown(WebElement element) {
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].scrollIntoView(false)",element);
	}
	//scroll up-30
	public static  void javaexecutorScrollUp(WebElement element) {
		JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	public static List<WebElement> elementsByID(String id) {
    ...
    public static List<WebElement> elementsByName(String name) {
   ...
   public static List<WebElement> elementsByClassName(String classs) {
   ...
   public static List<WebElement> elementsByXpath(String xpath) {
   ...
   public static List<WebElement> elementsByTagName(String tagName) {
